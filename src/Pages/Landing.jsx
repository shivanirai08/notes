  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-8 sm:px-6 lg:px-8 dark:bg-zinc-900">
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <button
          className="w-full sm:w-auto border border-blue-600 dark:border-blue-200 text-blue-600 dark:text-blue-200 font-medium px-4 py-2 rounded hover:bg-blue-100 dark:hover:bg-blue-500 transition"
